...
export class UserService {
    ...
    showRecording(id: string) {
        return this.http.put<any>(`${environment.apiUrl}/api/backend/user/show-recording/${id}`,null);
    }

    //hiddenRecording

    hiddenRecording(id: string) {
        return this.http.put<any>(`${environment.apiUrl}/api/backend/user/hidden-recording/${id}`, null);
    }
    deActive(id: string) {
